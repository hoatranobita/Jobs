            ...
            dbc.Card([
                dbc.CardBody([
                        ...
                        dbc.Row([
                            ...
                            ],width={'size':12,'offset':0,'order':1},style={'padding-top' : 25}),
                        ]),
                        dbc.Row([
                            dbc.Col([
                            dcc.Graph(id='volcano',figure={},style={'height':800,'width':'auto'}), #Volcano plot
                            ],width={'size':12,'offset':0,'order':2}),
                        ]),   
                        dbc.Row([
                            dbc.Col([
                            html.H6('log2FC',className='text-left')],width={'size':2,'offset':0,'order':2},style={'padding-left' : 25}), #Rangesilder to change log2
                            dbc.Col([
                            dcc.RangeSlider(
                        ...
                        dbc.Row([            
                            dbc.Col([
                            html.H6('P-adj',className='text-left')],width={'size':2,'offset':0,'order':2},style={'padding-left' : 25}),
                            dbc.Col([
                            dcc.Slider(
                            id='my-range-slider-2', # any name you'd like to give it
                            step=None,                # number of steps between values
                            min=0,
                            max=200,
                            marks={j: {'label': str(j)} for j in range(0, 200,15)},
                            value=50,
                            dots=True)              # default value initially chosen
                          ],width={'size':10,'offset':0,'order':2}),              
                    ]),  
                ])
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                        dbc.Row([           
                            dbc.Col([
                            html.H6('Adjust Colors',className='text-left'),
                            ],width={'size':4,'offset':0,'order':1},style={'padding-top' : 11}),                    
                            dbc.Col([
                        ...
                        dbc.Row([       
                            ...
                            ],width={'size':2,'offset':0,'order':1},style={'padding-top' : 22})        
                        ]),
            
                        dbc.Row([
                            dbc.Col([
                            dcc.Graph(id='heatmap',figure={},style={'height':500,'width':'auto'}), #Heatmap plot
                            ],width={'size':12,'offset':0,'order':2}),    
                        ]),
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.Row([
                            dbc.Col([        
                            html.H6('Select Genes',className='text-center',style={'padding-top' : 11}),
                        ...
                        dbc.Row([
                          dbc.Col([
                          dcc.Graph(id='line_graph',figure={},style={'height':350,'width':'auto'})    
                          ],width={'size':12,'offset':0,'order':2}),    
                        ])
                        ], className='text-center')
                    ])
...
def update_volcano(log_range,padj_range):
    volcano_plot = dash_bio.VolcanoPlot(dataframe=diff_df, 
                     ...
                     annotation = 'ANOT',
                     gene='GENENAME',
                     genomewideline_value=float(padj_range), #Range from input
...
app.run_server(port=8033,mode='inline') #You can delete mode='inline and dash will be open with link
